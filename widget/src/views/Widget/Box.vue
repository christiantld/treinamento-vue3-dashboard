<template>
  <div class="box animate__animated animate___fadeInUp animate__faster">
    <div
    ...
    >
      ...
      >
        <icon name="arrow-right" :color="'#1f2937'" />
      </button>
      <p
        v-if="canShowAdditionalControlAndInfo"
      ...
      <button
        ...
        class="text-xl text-gray-800 focus:outline-none"
      >
        <icon name="close" :color="'#1f2937'" size="14" />
      </button>
    </div>
    <wizard />
    <div
      ...
      v-if="canShowAdditionalControlAndInfo"
    >
      <icon name="chat" color="#bbb" class="mr-1" />
...
export default defineComponent({
  ...
  setup(_, { emit }: SetupContext): SetupReturn {
    ...
    const label = computed<string>(() => {
      ...
      return 'O que voce tem em mente?'
    })
