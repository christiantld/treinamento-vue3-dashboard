<template>
  ...
  >
    <h1 class="text-6xl font-black font-regular text-brand-gray">Playground</h1>
  ...
  >
    <h1 class="text-6xl font-black font-regular text-brand-graydark">😂</h1>
  </div>
  <div
    class="w-full h-3/4 flex flex-col justify-center items-center bg-brand-main"
  >
    <h1 class="text-6xl font-black font-regular text-brand-gray">😎</h1>
  </div>
  <div
    class="w-full h-3/4 flex flex-col justify-center items-center bg-brand-gray"
  >
